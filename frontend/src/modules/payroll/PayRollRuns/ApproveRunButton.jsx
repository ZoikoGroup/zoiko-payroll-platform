  ...
  return (
    <button
      ...
      className={`flex items-center gap-2 rounded-[12px] px-5 py-2.5 text-[13px] font-bold transition-all duration-200 ${
        disabled || approving
          ? "opacity-50 cursor-not-allowed bg-surface-muted text-foreground-muted"
          : "bg-primary text-white hover:bg-primary-hover shadow-[0_2px_8px_rgba(25,197,138,0.3)] hover:shadow-[0_4px_14px_rgba(25,197,138,0.4)] hover:-translate-y-[1px]"
      } ${className}`}
    >
      {approving ? (
