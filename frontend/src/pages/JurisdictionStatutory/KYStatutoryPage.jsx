...
export default function KYStatutoryPage() {
  ...
  return (
    <StatutoryRatesLayout
      ...
      onStateChange={(state) =>
        navigate(state ? `/super-admin/statutory-rates/cayman-islands/${encodeURIComponent(state)}` : "/super-admin/statutory-rates/cayman-islands", { replace: true })
      }
    />
  );
}
