...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('ppsn_supplied', sa.Boolean(), nullable=False, server_default=sa.text('1')),
        ...
        sa.Column('lpt_instructed', sa.Boolean(), nullable=False, server_default=sa.text('0')),
    ...
    op.create_table(
        ...
        sa.Column('contributions_ceased', sa.Boolean(), nullable=False, server_default=sa.text('0')),
